...
describe KalmanFilter do
  ...
  it 'should return a smoothed set of track points' do
    filtered_track_point_1 = @kalman_filter.apply @tp1, Time.new(0)
    expect(filtered_track_point_1).to eq @tp1

    filtered_track_point_2 = @kalman_filter.apply @tp2, Time.new(1)
    ...
    filtered_track_point_3 = @kalman_filter.apply @tp3, Time.new(2)
    ...
    filtered_track_point_4 = @kalman_filter.apply @tp4, Time.new(3)
    ...
    filtered_track_point_5 = @kalman_filter.apply @tp5, Time.new(3)
